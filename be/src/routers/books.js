...
import {createBook,getAllBooks,getBookById,updateBook,hideBook,deleteBook,getRelatedBooks} from "../controllers/books.js";
...
routerBook.get("/related/:id", getRelatedBooks);// Lấy sách tương tự
